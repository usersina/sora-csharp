# SORA - An Online Smart Reader (C#)

This is a university project that might grow to be something more than that.


## Dev tools
- [Folder structure](https://stackoverflow.com/questions/5283090/clean-solution-project-structure-with-ef-repositories-entities)
- [Entity Framework ORM](https://softchris.github.io/pages/dotnet-orm.html#create-a-migration)
- [Metro Framework](https://www.youtube.com/watch?v=mo5ONm3_Kno)
